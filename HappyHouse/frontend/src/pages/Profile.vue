  ...
  <div>
    ...
    <div class="section">
      <div class="container" style="height:1050px">
        ...
        <h5 class="text">
          <ul type="circle" style=" margin-left:400px">
            <li>이름: {{ this.name }}</li>
            <li>주소: {{ this.address }}</li>
            <li>핸드폰 번호: {{ this.phone }}</li>
          </ul>
        </h5>
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            <h4 class="title text-center">선호 지역</h4>
      ...
      var mapContainer = document.getElementById('map'), // 지도를 표시할 div
        mapOption = {
          center: new kakao.maps.LatLng(
            localStorage.getItem('loca_y'),
            localStorage.getItem('loca_x')
          ), // 지도의 중심좌표
          level: 5, // 지도의 확대 레벨
        };
